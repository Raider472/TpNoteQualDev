...
export class Heptathlon {
    ...
    protected setEpreuves() : void {
        ...
        this._epreuvesJours[0][2] = new Lancer("Lancer de poids");
        this._epreuvesJours[0][4] = new Course("200m");

        this._epreuvesJours[1] = [];
        this._epreuvesJours[1][2] = new Saut("Saut en longueur");
        this._epreuvesJours[1][3] = new Lancer("Lancer de javelot");
        this._epreuvesJours[1][4] = new Course("800m");
    }
